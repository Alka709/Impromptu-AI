  ...
  return (
    <div className="relative min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto py-12 px-8">
        ...
        <nav className="flex space-x-8 border-b border-zinc-200 mb-8" data-purpose="tab-navigation">
          {tabs.map(tab => (
            <button 
              key={tab}
        ...
        <div className="space-y-6">
          ...
          {activeTab === 'Danger Zone' && (
            <section className="bg-rose-50/50 rounded-3xl border-2 border-rose-100 p-10 animate-fade-in" data-purpose="danger-zone">
              ...
              <div className="pl-16">
                <button className="bg-white text-rose-600 border border-rose-200 shadow-sm rounded-full px-6 py-3 text-sm font-bold hover:bg-rose-600 hover:text-white transition-all active:scale-95">
